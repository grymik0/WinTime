...
public sealed class SettingsViewModel : BaseViewModel
{
    ...
    public bool WidgetShowApp
    {
        ...
        set
        {
            if (_settings.WidgetShowApp != value)
            {
                ...
                OnPropertyChanged(nameof(WidgetShowApp));
    ...
    public bool WidgetShowTime
    {
        ...
        set
        {
            if (_settings.WidgetShowTime != value)
            {
                ...
                OnPropertyChanged(nameof(WidgetShowTime));
                WidgetSettingsChanged?.Invoke(this, EventArgs.Empty);
            }
        }
    }
    ...
    public bool WidgetShowLevel
    {
        ...
        set
        {
            if (_settings.WidgetShowLevel != value)
            {
                ...
                OnPropertyChanged(nameof(WidgetShowLevel));
                WidgetSettingsChanged?.Invoke(this, EventArgs.Empty);
            }
        }
    }
    ...
    public bool WidgetShowMouse
    {
        ...
        set
        {
            if (_settings.WidgetShowMouse != value)
            {
                ...
                OnPropertyChanged(nameof(WidgetShowMouse));
                WidgetSettingsChanged?.Invoke(this, EventArgs.Empty);
            }
        }
    }
    ...
    public event EventHandler? WidgetSettingsChanged;
